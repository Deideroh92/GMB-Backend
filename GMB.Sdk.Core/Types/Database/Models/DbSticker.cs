namespace GMB.Sdk.Core.Types.Database.Models
{
    ...
    public class DbSticker(string placeId, double score, DateTime createdDate, byte[]? image, byte[]? certificate, int orderId, int nbRating1, int nbRating2, int nbRating3, int nbRating4, int nbRating5, int? id = null)
    {
