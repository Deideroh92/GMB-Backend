...
namespace GMB.Tests
{
    ...
    public class Launch
    {
        ...
        public void LaunchBusinessScanner()
        {
            ...
            ScannerController scannerController = new();
            BusinessScannerRequest request = new(9, 9, Operation.PROCESSING_STATE, true, DateTime.UtcNow.AddDays(-10), false, false, null, null, null, UrlState.NEW, false, false, false);
