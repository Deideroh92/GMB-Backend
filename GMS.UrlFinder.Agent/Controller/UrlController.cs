    ...
    public class UrlController {
        ...
        public static void Scraper(UrlRequest request) {
            ...
            if (request.DeptSearch)
                locations = File.ReadAllLines(Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.Parent.FullName, "GMS.Sdk.Core\\Files", "DeptList.txt"));
            if (request.CityCodeSearch)
                locations = File.ReadAllLines(Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.Parent.FullName, "GMS.Sdk.Core\\Files", "CpList.txt"));
