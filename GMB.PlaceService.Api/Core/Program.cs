...
namespace GMB.PlaceService.Api.Core
{
    ...
    public sealed class Program
    {
        ...
        public static IConfiguration Configuration { get; } = new ConfigurationBuilder()
            .SetBasePath(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.Parent.FullName + @"\GMB.PlaceService.Api")
            .AddJsonFile("GMB.PlaceService.Api.settings.json", optional: false, reloadOnChange: true)
